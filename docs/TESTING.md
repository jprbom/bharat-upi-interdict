...
- Local E2E smoke covers page render, sidebar tabs, model CTA, mule graph controls, mocked UPI response, Payment Ecosystem Timeline, create/patch/delete CRUD, read-only RBAC denial, and mobile render smoke.
