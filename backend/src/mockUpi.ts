...
const conceptCode = 'BHARAT_UPI_INTERDICT';
...
export function buildMockUpiResponse(input: MockUpiRailRequest) {
  ...
  return {
    ...
    npciStatus,
    responseCode,
    responseMessage: 'Bharat UPI Interdict sandbox response for ' + input.purpose + '. No real UPI rail, NPCI, bank, PSP, or customer data is used.',
    settlement: {
